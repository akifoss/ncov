---
title: Γενωμική ανάλυση της εξάπλωσης του COVID-19. Κατάσταση 2020-03-20.
authors:
  - Emma Hodcroft
  - Nicola Müller
  - Cassia Wagner
...
# [Πίνακας περιεχομένων](https://nextstrain.org/ncov/2020-03-20?d=tree,map&p=grid)
...
* [Δεδομένα αληλουχιών και ιστορικό ταξιδίων](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-20?n=6).
* [Διασπορά COVID-19 σχεδόν σε όλες τις χώρες](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-20?n=8).
* [Πώς μεγαλώνουν οι εστίες μετάδοσης και διασπείρονται](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-20?n=9).
* [Πώς μεγάλωσαν οι εστίες μετάδοσης στην Ουάσινκτον](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-20?n=10).
* [Πώς έγινε η επέκταση της εστίας μετάδοσης στη Ουάσινγκτον](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-20?n=11).
* [Πώς μεταβάλλονται οι αριθμοί κρουσμάτων όταν εφαρμόζονται μέτρα κοινωνικής απόστασης.](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-20?n=12).
* [Τι μπορείτε να κάνετε](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-20?n=13).
...
Σε αυτή την αναφορά έχουμε αναλύσει 723 δημοσίως διαθέσιμα COVID-19 γονιδιώματα. Συγκρίνοντας τα ιικά γονιδιώματα μεταξύ τους, μπορούμε να χαρακτηρίσουμε το πώς εξελίσσεται και κινείται η νόσος COVID-19 σε όλο τον κόσμο.

Σε αυτή την αναφορά υπογραμμίζουμε ότι ο ιός έχει εισαχθεί και κυκλοφορεί σε πολλά μέρη του πλανήτη.

Γνωρίζοντας εάν και σε ποιο βαθμό κυκλοφορεί η COVID-19 τοπικά και πώς τα μέτρα περιορισμού μπορούν να επιβραδύνουν αυτή την εξάπλωση απαιτεί καλή γνώση της τοπικής δυναμικής της επιδημίας. Αυτό με τη σειρά του απαιτεί εκτεταμένους ελέγχους.

Αυτό υπογραμμίζει τη σημασία των άμεσων ελέγχων με μεγάλη έμφαση στην επιβράδυνση των τοπικών μεταδόσεων.

Στις ενημερώσεις αυτής της εβδομάδας αναφέρουμε:  

* Αποδεικτικά στοιχεία για εισαγωγές που σχετίζονται με ταξίδια σε πολλά μέρη του κόσμου.
* Πολλά μέρη με πρόσφατες εισαγωγές μπορούν να αναμένουν να δουν τα κρούσματα να επεκτείνονται σε χρονικό διάστημα 4-8 εβδομάδων. Θα πρέπει να προετοιμαστούν τώρα.
* Πολλά μέρη που έχουν εφαρμόσει πρόσφατα μέτρα κοινωνικής απομάκρυνσης μπορούν να αναμένουν ότι τα κρούσματα θα εξακολουθήσουν να συσσωρεύονται βραχυπρόθεσμα, αλλά τα νέα κρούσματα πιθανότατα θα αγγίξουν ένα πλατώ και θα μειωθούν μεσοπρόθεσμα έως μακροπρόθεσμα.
* Η διενέργεια ελέγχων, τόσο για τις ενεργές λοιμώξεις όσο και για άτομα που έχουν ανακάμψει, θα είναι ζωτικής σημασίας για την αντιμετώπιση αυτής της επιδημίας.
```
...
# [COVID-19 Πηγές](https://nextstrain.org/ncov/2020-03-20)
Έχουμε ετοιμάσει κάποιους συνδέσμους που αξίζει να διαβάσετε για να εξοικειωθείτε με το COVID-19 και τον ιό που το προκαλεί, τον SARS-CoV-2.
Οι πληροφορίες αυτές θα διευκολύνουν την ερμηνεία των δεδομένων που παρουσιάζουμε σε αυτή την αφήγηση. Αν δεν είστε εξοικειωμένοι με φυλογενετικά δέντρα, σας συνιστούμε να ελέγξετε το άρθρο  ['Πώς να διαβάσετε μια φυλογένεση'](https://nextstrain.org/narratives/trees-background/) και να επιστρέψετε όταν είστε έτοιμοι .
...
* Περίληψη της επιδημίας του ιού SARS-CoV-2 [Wikipedia](https://el.wikipedia.org/wiki/Πανδημία_κορονοϊού_2019–20).
* Όλοι οι αριθμοί των κρουσμάτων που αναφέρονται στην παρούσα έκθεση προέρχονται από τον Παγκόσμιο Οργανισμό Υγείας  [ΠΟΥ](https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200318-sitrep-58-covid-19.pdf?sfvrsn=20876712_2) από τις 20.03.2020 .
```

<!-- ############ SLIDE BREAK ############# -->

<!-- This is left-side text 3 -->
# [Μια σημείωση σχετικά με τη δειγματοληψία](https://nextstrain.org/ncov/2020-03-20?c=country&r=country&d=map&p=grid&legend=closed)
Αυτή τη στιγμή έχουμε ακολουθίες από δείγματα που έχουν ληφθεί σε 36 χώρες σε 6 ηπείρους. Αυτό είναι ένα αξιόλογο κατόρθωμα - η αλληλούχηση ενός άγνωστου, μεγάλου ιού RNA στη μέση μιας πανδημίας είναι δύσκολη και είναι είναι η εξαιρετική δουλειά και ο συνεχής διαμοιρασμός δεδομένων από επιστήμονες και γιατρούς σε όλο τον κόσμο που την καθιστούν δυνατή.
<br><br>
Τα δεδομένα αυτά μας επιτρέπουν να συνάγουμε πολλά χρήσιμα χαρακτηριστικά της επιδημίας και να παρακολουθήσουμε την εξάπλωσή της σε πραγματικό χρόνο. Ωστόσο, είναι σημαντικό να τονίσουμε ότι τα συμπεράσματά μας περιορίζονται από τη διαθεσιμότητα των δεδομένων.
Από το συνολικό αριθμό των κρουσμάτων, μόνο ένα μέρος υποβάλλεται σε έλεγχο. Από αυτά που ελέγχονται, μόνο ένα υποσύνολο δειγμάτων υποβάλλεται σε αλληλούχηση.
Το υποσύνολο των κρουσμάτων που υπόκειται σε έλεγχο μπορεί να ποικίλλει σημαντικά στις διάφορες γεωγραφικές τοποθεσίες αλλά και μέσα στο χρόνο.
Επιπλέον, οι φυλογενετικές ανακατασκευές των επιδημιών συνδέονται πάντοτε με ένα βαθμό αβεβαιότητας.
<br><br>
...
# [Ορισμένες περιοχές δεν αντιπροσωπεύονται στα δεδομένα αυτά](https://nextstrain.org/ncov/2020-03-20?c=country&d=map&f_region=Central%20America,Oceania,South%20America,Africa&legend=closed&p=full&r=country)
Ο χάρτης δείχνει πολύ λίγες αλληλουχίες από τη νότια περιοχή της υφηλίου. Για παράδειγμα, έχουμε αλληλουχίες για μόλις 4 από τις 25 χώρες της Λατινικής Αμερικής όπου [ο ΠΟΥ αναφέρει](https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200319-sitrep-59-covid-19.pdf?sfvrsn=c3dcdef9_2) κρούσματα του COVID-19. Αυτό δεν οφείλεται στο γεγονός ότι το COVID-19 δεν κυκλοφορεί στις περιοχές αυτές ή ότι αυτές οι περιπτώσεις δεν είναι τόσο κρίσιμες για να κατανοήσουμε. Αντίθετα, απλά δεν διαθέτουμε πολλά δεδομένα από αυτές τις περιοχές.
<br><br>
<!-- There is NO right-side text -->
...
# [Άλλες περιοχές υπερ-αντιπροσωπεύονται σε αυτά τα δεδομένα](https://nextstrain.org/ncov/2020-03-20?c=country&d=map&f_region=Europe&legend=closed&p=full&r=country)
Σε άλλες περιοχές, όπως η Ολλανδία, υπάρχει διαθέσιμος ένας τεράστιος αριθμός αλληλουχιών σε σχέση με το συνολικό αριθμό περιπτώσεων.
<br><br>
Έτσι, κατά την ανάγνωση αυτής της αφήγησης, να έχετε κατά νου ότι το μέγεθος κάθε κύκλου στον χάρτη αντιπροσωπεύει το μέγεθος των δεδομένων που είναι αυτή τη στιγμή διαθέσιμα από την εκάστοτε περιοχή και όχι το πραγματικό μέγεθος της επιδημίας. Μπορείτε να [διαβάσετε εδώ](https://nextstrain.org/narratives/trees-background?n=8) για το πώς αυτό μπορεί να επηρεάσει τα συμπεράσματά μας για μετάδοση.
<br><br>
...
# [Τα δεδομένα από τις αλληλουχίες μπορούν να διασταυρώσουν ιστορικά ταξιδιών](https://nextstrain.org/ncov/2020-03-20?legend=open&c=division_exposure&label=clade:A1a&d=tree)

Ο εντοπισμός του τόπου όπου μολύνθηκε ένα κρούσμα είναι σημαντικό για την κατανόηση των περιοχών που αντιμετωπίζουν τοπική μετάδοση σε σχέση με τις περιπτώσεις που σχετίζονται κυρίως με ταξίδια. Οι αλληλουχίες μπορούν να μας βοηθήσουν να διαφοροποιήσουμε τα σενάρια αυτά.
<br><br>
Εδώ, το δέντρο είναι χρωματισμένο με βάση το ιστορικό ταξιδιού ενός κρούσματος (όταν είναι γνωστό). Κοιτάζοντας την καναδική αλληλουχία (Canada/BC_78548/2020) στη μέση, παρατηρούμε ότι έχει ένα ταξιδιωτικό ιστορικό στην Ευρώπη. Αυτό το περιστατικό ομαδοποιείται με άλλες ευρωπαϊκές αλληλουχίες, γεγονός που δείχνει ότι αυτό το κρούσμα είναι σίγουρα μια μόλυνση που σχετίζεται με το ταξίδι.

<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 7 -->
# [Τα δεδομένα από τις αλληλουχίες μπορούν να διασταυρώσουν ιστορικά ταξιδιών](https://nextstrain.org/ncov/2020-03-20?c=division_exposure&d=tree&f_division_exposure=Iran&legend=open&p=full)

Με σμίκρυνση, βλέπουμε ότι αυτό δεν είναι πάντα τόσο συνεπές.
<br><br>
Εδώ μπορούμε να δούμε ότι σχεδόν όλα τα κρούσματα που έχουν πρόσφατα ιστορικά ταξιδίων στο Ιράν συγκεντρώνονται στο μέσον του δέντρου.
<br><br>
Προς την κορυφή του δέντρου, βλέπουμε επίσης ένα καναδικό κρούσμα με ιστορικό ταξιδιού στο Ιράν. Ωστόσο, αυτή η αλληλουχία δεν ομαδοποιείται με κανένα άλλο κρούσμα που έχει ιστορικό ταξιδιού στο Ιράν.
<br><br>
Είναι σίγουρα πιθανό αυτό το άτομο είχε μολυνθεί από μια δευτερογενή αλυσίδα μετάδοσης του ιού στο Ιράν, αλλά μέχρι να έχουμε περισσότερα δεδομένα δεν μπορούμε να επιβεβαιώσουμε ότι αυτή η μόλυνση έλαβε χώρα στο ταξίδι.
...
# [Ο ιός έχει εισαχθεί σχεδόν σε όλες τις χώρες του κόσμου](https://nextstrain.org/ncov/2020-03-20?legend=closed&c=country&d=tree,map&p=grid)

Στο δέντρο βλέπουμε πολλά ανάμικτα δείγματα από διαφορετικές χώρες.
Αυτό δείχνει ότι αυτού του είδους η αναπόφευκτη μετακίνηση των ανθρώπων έχει ήδη εισάγει τον ιό σε πολλά μέρη της υφηλίου.
<br><br>
Όντως [ο ΠΟΥ αναφέρει](https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200319-sitrep-59-covid-19.pdf?sfvrsn=c3dcdef9_2) ότι υπάρχουν 159 επιβεβαιωμένα κρούσματα σε 159 από τις 195 χώρες του κόσμου. 
<br><br>
Ωστόσο, δεν καταλήγουν όλες οι εισαγωγές σε επιδημίες.

<!-- There is no right side text -->

<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 9 -->
# [Οι επιδημίες φανερώνονται περίπου 4-8 εβδομάδες μετά την εισαγωγή τους](https://nextstrain.org/ncov/2020-03-20?legend=closed&c=num_date&d=tree&f_division=Washington&label=clade:B1&p=full)

Ίσως φαίνεται ότι το COVID-19 εξερράγη ξαφνικά.
Για πολλούς ανθρώπους αυτό το ξέσπασμα μπορεί να έγινε από μια αφηρημένη ανησυχία που αγγίζει μακρινά μέρη του κόσμου σε κάτι που έχει σοβαρές επιπτώσεις στην καθημερινή τους ζωή, φαινομενικά απο τη μια μέρα στην άλλη.
<br><br>
Όμως ας έχουμε κατά νου ότι αυτό είναι κάτι που κυκλοφορεί ήδη κάποιον καιρό. Δε σημαίνει απαραίτητα ότι ο ιός εισάγεται σε μερικά μέρη πιο συχνά από ότι σε άλλα.
Το πιο πιθανό είναι ότι σε πολλά μέρη τώρα γίνεται αντιληπτή η επιδημία η οποία ωστόσο είχε ήδη ξεκινήσει αρκετές εβδομάδες πριν.
<br><br>
Περιοχές που δεν γνωρίζουν ακόμη τοπικά κρούσματα θα πρέπει να προετοιμαστούν τώρα και να ξεκινήσουν τους ελέγχους επιτήρησης.
<!-- This is the right-side text -->

```auspiceMainDisplayMarkdown
# Πώς οι εισαγωγές μετατρέπονται σε εστίες

Μερικές φορές οι εισαγωγές δεν οδηγούν σε δευτερογενή κρούσματα ή εντοπισμένες εστίες - ειδικά εάν το αρχικό κρούσμα εντοπιστεί και απομονωθεί εγκαίρως.
Πολλές φορές, ωστόσο, ο ιός εξαπλώνεται χωρίς να εντοπίζεται στον τοπικό πληθυσμό μέχρι το ξέσπασμα να αγγίξει ένα σημαντικό μέρος του πληθυσμού.

Παρακάτω είναι ένα πείραμα σκέψης που δείχνει πώς πώς το παραπάνω έπαιξε ρόλο στο Wuhan. Ο άξονας ψ αντιπροσωπεύει το χώρο, ο άξονας χ το χρόνο. Η σκιασμένη περιοχή αντιπροσωπεύει τον αριθμό των κρουσμάτων.

"Ο COVID-19 στο Wuhan εξελίχθηκε από ένα μοναδικό κρούσμα την περίοδο του Νοέμβριο 2019, σε πολλές χιλιάδες κρούσματα στα μέσα Ιανουαρίου 2020, ξεκινώντας από ένα αρχικό περιστατικό και καταλήγοντας σε μια εκτεταμένη τοπική εξάπλωση σε ένα χρονικό διάστημα περίπου 10 εβδομάδων. Θεωρούμε ότι τα διεθνή γεγονότα διασποράς του ιού ξεκίνησαν γύρω στα μέσα του Ιανουαρίου 2020. Επομένως έχουμε τις περίπου 10 κρίσιμες εβδομάδες από τότε έως και τα τέλη Μαρτίου ώστε να περιορίσουμε τα γεγονότα αυτά της πανδημίας πριν να πάρουν μεγάλες διαστάσεις." [- Trevor Bedford](https://twitter.com/trvrb/status/1226241284207038464), Φεβρουάριος 2020
...
# [Πώς μεγαλώνουν οι εστίες μετάδοσης: ένα παράδειγμα](https://nextstrain.org/ncov/2020-03-20?legend=closed&d=tree,map&f_division=Washington&label=clade:B1&p=grid&r=location)
Βλέπουμε ένα ξεκάθαρο παράδειγμα ανάπτυξης στα δεδομένα από την πολιτεία της Ουάσινγκτον.
Η κύλιση του κέρσορα πάνω στη ρίζα του κεντρικού κλαδιού δείχνει ότι ο ιός πιθανών εισήχθη σε αυτήν την περιοχή μεταξύ του τέλους Ιανουαρίου και τα μέσα Φεβρουαρίου 2020 ([μέθοδοι](https://nextstrain.org/narratives/trees-background?n=6)).
<br><br>
...
# [Πώς μεγαλώνουν οι εστίες μετάδοσης: ένα παράδειγμα](https://nextstrain.org/ncov/2020-03-20?legend=closed&d=tree,map&f_division=Washington,Utah&label=clade:B1&p=grid)

Μπορούμε επίσης να δούμε ένα παράδειγμα του πώς αρχικά εντοπισμένες τοπικά, σπείρουν τον ιό σε άλλες τοποθεσίες.
Τα δείγματα από τη Γιούτα κοντά στην κορυφή του δέντρου (πορτοκαλί χρώμα) φωλιάζουν μέσα στο κύριο κλαδί της εστίας της Ουάσινγκτον.
Το γεγονός αυτό σημαίνει ότι υπήρξε μια εισαγωγή από την Washington στη Utah, αφήνοντας ωστόσο την πιθανότητα να υπήρχαν ενδιάμεσα βήματα στην αλυσίδα μετάδοσης.
<br><br>
Δεν γνωρίζουμε με σιγουριά εάν αυτή η εισαγωγή θα οδηγήσει σε τοπικό ξέσπασμα στη Γιούτα.
Ωστόσο, αν ο ιός συνεχίσει να εξαπλώνεται μετά από αυτές τις εισαγωγές, αναμένουμε να δούμε την εξάπλωση να ξεδιπλώνεται μέσα στις επόμενες 4 εβδομάδες.
<br><br>
Αυτό είναι μόνο ένα παράδειγμα.
Μπορεί να υπάρχουν κι άλλες εισαγωγές στη Γιούτα (ή σε άλλες περιοχές) που δεν μπορούμε να δούμε στο δέντρο γιατί δεν έχουν αλληλουχηθεί.
Το πιο σημαντικό ωστόσο είναι να προετοιμαστούν τώρα οι περιοχές που δεν έχουν καταγράψει κρούσματα και να ξεκινήσουν ελέγχους επιτήρησης.
<!-- There is no right side text -->

<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 12 -->
# [Τα μέτρα απομόνωσης χρειάζονται χρόνο, αλλά σώζουν ζωές](https://nextstrain.org/ncov/2020-03-20)

Ακολουθώντας την ίδια λογική, ενδεχομένως να υπάρχουν πολλές τοπικές αλυσίδες μετάδοσης τις οποίες δε γνωρίζουμε. 
<br><br>
Αυτό σημαίνει  ότι ακόμα και σε περιοχές που έχουν επιβληθεί μέτρα κοινωνικού περιορισμού, θα πρέπει να αναμένουμε ότι τα κρούσματα θα αυξηθούν τις επόμενες εβδομάδες. Αυτές οι αυξήσεις ΔΕΝ αποτελούν απόδειξη ότι τα μέτρα απομόνωσης δε λειτουργούν. Χρειάζετει να περάσει χρόνος ώστε αυτοί που φέρουν τον ιό (και πιθανώς και τα μέλη των οικογενειών τους) να αναπτύξουν συμπτώματα, να νοσηλευθούν και να ανακάμψουν. Αναμένουμε επίσης να δούμε μια μεγάλη αύξηση στον αριθμό των επιβεβαιωμένων κρουσμάτων, όσο οι έλεγχοι πραγματοποιούνται σε μεγαλύτερο φάσμα και καθίστανται ευρέως διαθέσιμοι. 
<br><br>
Είναι καθοριστικής σημασίας να διατηρούνται τα μέτρα απομόνωσης αυτήν την περίοδο. Όπως φαίνεται στα δεξιά, ο αριθμός των κρουσμάτων συνεχίζει να αυξάνεται και μετά την επιβολή των μέτρων. Όμως σε βάθος χρόνου, ο αριθμός των κρουσμάτων που συσσωρεύονται μειώνεται σημαντικά.
<!-- This is the right-side text -->

```auspiceMainDisplayMarkdown
## Τα μέτρα απομόνωσης δε σταματούν την εξάπλωση μέσα σε μία νύχτα, αλλά μειώνουν σημαντικά τον αριθμό κρουσμάτων και θανάτων μέσα στο χρόνο.
Τα μέτρα κοινωνικής απομόνωσης - δηλαδή μείωση του αριθμού των ανθρώπινων συναναστροφών μέσα στη μέρα - μπορεί να είναι δύσκολα στην εφαρμογή τους, είναι ωστόσο κρίσιμης σημασίας για το κοινό καλό.  

 Αν ο καθένας μείωνε τις καθημερινές επαφές κατά 25%, αναμένεται μείωση κατά 50% του συνολικού αριθμού κρουσμάτων μέσα στον επόμενο μήνα ([Klein κλπ., 2020-03-13](https://institutefordiseasemodeling.github.io/COVID-public/reports/Working%20paper%20%E2%80%93%20model-based%20estimates%20of%20COVID-19%20burden%20in%20King%20and%20Snohomish%20counties%20through%20April%207.pdf)).
<div>
...
# [Σύνοψη](https://nextstrain.org/ncov/2020-03-20?c=country&d=map&p=full)
- Ο ιός έχει εισαχθεί σε πολλά μέρη του πλανήτη πολλαπλές φορές.
<br>
- Υπάρχουν ενδείξεις για τοπική διασπορά σε πολλές περιοχές. Πέραν τούτου, αναμένουμε ότι οι προγενέστερες εισαγωγές έχουν ήδη εμφυτεύσει πολλές τοπικές επιδημίες οι οποίες θα φανερωθούν τις ερχόμενες εβδομάδες.
<br>
- Η συγκράτηση των τοπικών επιδημιών μέσω μέτρων απομόνωσης είναι ζωτικής σημασίας για να :
  - Ισοπεδωθεί η καμπύλη (#FlattenTheCurve) ώστε να αποφευχθεί η η υπερφόρτωση των συστημάτων υγείας από συρρέοντα περιστατικά
  - Μειωθεί ο συνολικός αριθμός κρουσμάτων και θανάτων
  - Δοθεί χρόνος ώστε να αναπτυχθούν θεραπείες και εμβόλια
   
<!-- This is the right-side text -->
...
## ...ο καθένας ξεχωριστά
* Μειώστε δραματικά τον αριθμό των ανθρώπων που έρχεστε σε επαφή καθημερινά, ειδικά εάν ανήκετε σε ομάδα κινδύνου (π.χ. ηλικιωμένοι και άνθρωποι με βεβαρυμένο ιστορικό υγείας).
...
* Υποστηρίξτε οικονομικά αυτούς που πλήγονται από τα μέτρα αποκλεισμού (π.χ. ωρομίσθιους, ανθρώπους που εργάζονται στον τομέα φροντίδας παιδιών και ηλικιωμένων, μικρές επιχειρήσεις, κλπ)
...
<!-- This is left-side text 13-->
# [Λεπτομερής επιστημονική αναγνώριση](https://nextstrain.org/ncov/2020-03-20?d=map&c=author)
