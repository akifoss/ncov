...
Εδώ, έχουμε αναλύσει 723 δημόσια διαθέσιμα COVID-19 γονιδιώματα. Συγκρίνοντας τα ιικά γονιδιώματα μεταξύ τους, μπορούμε να χαρακτηρίσουμε το πώς εξελίσσεται και κινείται η νόσος COVID-19 σε όλο τον κόσμο.
...
Από τον συνολικό αριθμό των κρουσμάτων, μόνο ένα μέρος υποβάλλεται σε έλεγχο. Από αυτά που ελέγχονται, μόνο ένα υποσύνολο δειγμάτων υποβάλλεται σε αλληλούχηση.
...
Σε άλλες περιοχές, όπως η Ολλανδία, υπάρχει διαθέσιμος ένας τεράστιος αριθμός αλληλουχιών σε σχέση με τον συνολικό αριθμό περιπτώσεων.
<br><br>
